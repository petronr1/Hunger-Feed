...
<!-- Italian -->
	...
	<div id="myCarousel8" class="carousel slide">
	  <ol class="carousel-indicators">
		<li class="active" data-slide-to="0" data-target="#myCarousel8"></li>
		<li class="" data-slide-to="1" data-target="#myCarousel8"></li>
		<li class="" data-slide-to="2" data-target="#myCarousel8"></li>
	  </ol>
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
	...
	<div id="myCarousel9" class="carousel slide">
	  <ol class="carousel-indicators">
		<li class="active" data-slide-to="0" data-target="#myCarousel9"></li>
		<li class="" data-slide-to="1" data-target="#myCarousel9"></li>
		<li class="" data-slide-to="2" data-target="#myCarousel9"></li>
	  </ol>
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
	...
	<div id="myCarousel10" class="carousel slide">
	  <ol class="carousel-indicators">
		<li class="active" data-slide-to="0" data-target="#myCarousel10"></li>
		<li class="" data-slide-to="1" data-target="#myCarousel10"></li>
		<li class="" data-slide-to="2" data-target="#myCarousel10"></li>
	  </ol>
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
      ...
      <a class="left carousel-control" href="#myCarousel10" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
      <a class="right carousel-control" href="#myCarousel0" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
    </div><!-- /.carousel -->
