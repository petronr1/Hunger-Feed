...
for($i = 0; $i < mysqli_num_rows($dishes_sandwiches); $i++)
{
...
<!-- Italian -->
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
				<div class="col-xs-3"><?php $var= (rand(1,$count_brunch));?><a href="food_info.php?info=<?php echo $id_brunch[$var]?>" class="thumbnail"><img src="<?php echo $img_brunch[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_brunch));?><a href="food_info.php?info=<?php echo $id_brunch[$var]?>" class="thumbnail"><img src="<?php echo $img_brunch[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_brunch));?><a href="food_info.php?info=<?php echo $id_brunch[$var]?>" class="thumbnail"><img src="<?php echo $img_brunch[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_brunch));?><a href="food_info.php?info=<?php echo $id_brunch[$var]?>" class="thumbnail"><img src="<?php echo $img_brunch[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
				<div class="col-xs-3"><?php $var= (rand(1,$count_sandwiches));?><a href="food_info.php?info=<?php echo $id_sandwiches[$var]?>" class="thumbnail"><img src="<?php echo $img_sandwiches[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_sandwiches));?><a href="food_info.php?info=<?php echo $id_sandwiches[$var]?>" class="thumbnail"><img src="<?php echo $img_sandwiches[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_sandwiches));?><a href="food_info.php?info=<?php echo $id_sandwiches[$var]?>" class="thumbnail"><img src="<?php echo $img_sandwiches[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_sandwiches));?><a href="food_info.php?info=<?php echo $id_sandwiches[$var]?>" class="thumbnail"><img src="<?php echo $img_sandwiches[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
				<div class="col-xs-3"><?php $var= (rand(1,$count_mexican));?><a href="food_info.php?info=<?php echo $id_mexican[$var]?>" class="thumbnail"><img src="<?php echo $img_mexican[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_mexican));?><a href="food_info.php?info=<?php echo $id_mexican[$var]?>" class="thumbnail"><img src="<?php echo $img_mexican[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_mexican));?><a href="food_info.php?info=<?php echo $id_mexican[$var]?>" class="thumbnail"><img src="<?php echo $img_mexican[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_mexican));?><a href="food_info.php?info=<?php echo $id_mexican[$var]?>" class="thumbnail"><img src="<?php echo $img_mexican[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="item active">
			<div class="row">
				<div class="col-xs-3"><?php $var= (rand(1,$count_chinese));?><a href="food_info.php?info=<?php echo $id_chinese[$var]?>" class="thumbnail"><img src="<?php echo $img_chinese[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_chinese));?><a href="food_info.php?info=<?php echo $id_chinese[$var]?>" class="thumbnail"><img src="<?php echo $img_chinese[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_chinese));?><a href="food_info.php?info=<?php echo $id_chinese[$var]?>" class="thumbnail"><img src="<?php echo $img_chinese[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
				<div class="col-xs-3"><?php $var= (rand(1,$count_chinese));?><a href="food_info.php?info=<?php echo $id_chinese[$var]?>" class="thumbnail"><img src="<?php echo $img_chinese[($var)]; ?><?php echo rand(1,1);?>.jpg" /></a></div>
