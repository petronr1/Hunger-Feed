...
$sql=("SELECT past_dishes FROM profile WHERE email='$email_cookie'");
$result= mysqli_query($con, $sql);
$array = mysqli_fetch_array($result);
$id_past = $array['past_dishes'];

$sql=("SELECT * FROM dish WHERE id='$id_past'");
$result= mysqli_query($con, $sql);
$array = mysqli_fetch_array($result);
$path_past = $array['img_path'];
$name_past = $array['dish_name'];
...
<div class="col-md-7">
<h2 class="featurette-heading"><?php echo $name_past;?></h2>
<div>
